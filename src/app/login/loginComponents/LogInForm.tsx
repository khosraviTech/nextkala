    ...
    <div className="flex justify-center items-center  bg-gray-100">
      ...
      >
        ...
        <div className="w-full">
          <button
            type="submit"
            className=" cursor-pointer border-2 rounded-4xl m-1 p-1 w-full h-10"
          >
            LogIn
          </button>
          {/* Error message */}
        ...
        <button
          ...
          className="cursor-pointer w-full flex items-center justify-center gap-3 px-4 py-2 border rounded-lg hover:bg-gray-50 transition mt-2"
        >
        ...
        <button
          ...
          className="cursor-pointer w-full flex items-center justify-center gap-3 px-4 py-2 border rounded-lg hover:bg-gray-50 transition"
        >
