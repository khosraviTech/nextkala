    ...
    <div className="flex justify-center items-center text-primary">
      ...
      >
        ...
        <button
          ...
          className="cursor-pointer w-full flex items-center justify-center gap-3 px-4 py-2 border rounded-lg transition  hover:bg-accent-green hover:text-white hover:border-accent-green"
        >
