...
export default function AboutMe() {
  return (
    <div className=" grid  border-2 grid-rows-12 grid-cols-12 gap-2 p-6 border-red-500 ">
      ...
      <button className="row-start-10 row-end-12 col-start-6 col-end-11 text-primary text-sm inline-flex w-full items-center justify-between border pl-4 border-accent-green rounded-2xl p-2">
  More About Me
